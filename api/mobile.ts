...
import { absoluteUrl, corsPreflight, json, withCors } from "../src/lib/http.js";
...
async function mobileHandler(request: Request): Promise<Response> {
...
export { mobileHandler };
export default createVercelNodeHandler(mobileHandler);
